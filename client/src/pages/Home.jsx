    ...
    return(
        <div className='w-full h-screen bg-[#e5e1e1] flex flex-col items-center'>
            <div className='w-full relative'>
                <img className='absolute right-0 -top-20'  src={bg1} alt="" />
            </div>
            <div className="flex items-center flex-col text-center pt-12 md:pt-28 pb-20 px-6 md:px-12 relative z-10">
                ...
                <NavLink to="/login"><button  className="bg-[#4E52C1] text-white px-8 py-2 my-12 rounded-3xl text-lg font-semibold">Get Started</button></NavLink>
            </div>
            <div className='w-full relative'>
                <img className='absolute left-0 -bottom-[340px]' src={bg2} alt="" />
            </div>
        </div>
    )
}
